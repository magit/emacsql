...
Any [[https://nullprogram.com/blog/2013/12/30/#almost_everything_prints_readably][readable lisp value]] can be stored as a value in EmacSQL, including
...
The author of EmacSQL [[https://github.com/magit/emacsql/issues/35#issuecomment-346352439][mistake]] that it was probably a design mistake to
restrict it to Emacs by storing only printed values, and that it would
be a lot more useful if it just handled primitive database types.
...
When editing these prepared SQL s-expression statements,
the ~M-x emacsql-show-last-sql~ command (think ~eval-last-sexp~) is useful
for seeing what the actual SQL expression will become when compiled.
...
#+html: <br><br>
#+html: <a href="https://github.com/magit/emacsql/actions/workflows/compile.yml"><img alt="Compile" src="https://github.com/magit/emacsql/actions/workflows/compile.yml/badge.svg"/></a>
#+html: <a href="https://github.com/magit/emacsql/actions/workflows/test.yml"><img alt="Test" src="https://github.com/magit/emacsql/actions/workflows/test.yml/badge.svg"/></a>
#+html: <a href="https://snapshots.melpa.org/#/emacsql"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/emacsql-badge.svg"/></a>
#+html: <a href="https://releases.melpa.org/#/emacsql"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/emacsql-badge.svg"/></a>
#+html: <a href="https://elpa.nongnu.org/nongnu/emacsql.html"><img alt="NonGNU ELPA" src="https://emacsair.me/assets/badges/nongnu-elpa.svg"/></a>
